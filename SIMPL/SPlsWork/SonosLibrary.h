namespace SonosLibrary.SimplPlusInterfaces.Impl;
     ...
     class MediaPlayerDeviceSimplPlusInterface 
    {
        ...
        FUNCTION DisplayOn ();
        FUNCTION DisplayOff ();
        FUNCTION LoadHomeTheaterPlayback ();
        FUNCTION MonoMode ();
        FUNCTION WifiDisable ();
        FUNCTION PlayerVolumeMode ( INTEGER mode );
        FUNCTION PlayerVolumeScaleFactor ( INTEGER volumeScaleFactor );
        FUNCTION LeaveGroup ();
        FUNCTION LoadAudioClip ( STRING streamUrl );
        ...
        FUNCTION QueueActionReplace ( INTEGER replace );
        ...
        STRING NowPlayingLines[][];
        INTEGER IsVolumePassThrough;
        INTEGER SettingsVolumeMode;
        INTEGER SettingsVolumeScalingFactor;
        INTEGER SettingsWifiDisable;
        INTEGER SettingsMonoMode;
        INTEGER AudioclipStatus;
        ...
        DelegateProperty DelegateFn PlayerSettingsUpdate;
        DelegateProperty DelegateFn AudioclipStatusUpdate;
        STRING DefaultPlayerName[];
...
namespace SonosProLibrary.API.Events;
        // class declarations
         ...
         class PlayerSettingsChangedEventArgs;
     class SonosApiInformationChangedEventArgs 
    {
        // class delegates
...
namespace SonosProLibrary.DataStructures;
        // class declarations
         ...
         class ListItem;
         class SonosService;
         class AudioClipStatusMessageStructure;
         class AudioClipStatusRootObject;
         class AudioClips;
     class PlaybackStatusMessageStructure 
    {
        // class delegates
...
namespace SonosProLibrary.Diagnostics.Impl;
        // class declarations
         class SonosDeviceEventDiagnosticInformation;
           class SonosDeviceEvent;

namespace SonosProLibrary.API.Enums;
        // class declarations
         class SonosSystemEvent;
         class SonosDeviceEvent;
         class SonosContentType;
         class SonosGroupStatus;
         class SonosPlaybackError;
         class SonosPlayerCommand;
    ...
    static class SonosDeviceEvent // enum
    {
        ...
        static SIGNED_LONG_INTEGER Settings;
        static SIGNED_LONG_INTEGER Audioclip;
    };

    static class SonosContentType // enum
    {
        static SIGNED_LONG_INTEGER NotAvailable;
        static SIGNED_LONG_INTEGER Album;
        static SIGNED_LONG_INTEGER Artist;
        static SIGNED_LONG_INTEGER Audiobook;
        static SIGNED_LONG_INTEGER ChapterAudiobook;
        static SIGNED_LONG_INTEGER Container;
        static SIGNED_LONG_INTEGER Episode;
        static SIGNED_LONG_INTEGER Linein;
        static SIGNED_LONG_INTEGER LineinTheater;
        static SIGNED_LONG_INTEGER Playlist;
        static SIGNED_LONG_INTEGER Show;
        static SIGNED_LONG_INTEGER Station;
        static SIGNED_LONG_INTEGER StationBroadcast;
        static SIGNED_LONG_INTEGER Track;
        static SIGNED_LONG_INTEGER Tracklist;
    };

    static class SonosGroupStatus // enum
    {
        static SIGNED_LONG_INTEGER None;
        static SIGNED_LONG_INTEGER Removed;
        static SIGNED_LONG_INTEGER CoordinatorChanged;
        static SIGNED_LONG_INTEGER Updated;
    };

    static class SonosPlaybackError // enum
    {
        static SIGNED_LONG_INTEGER None;
        static SIGNED_LONG_INTEGER PlaybackFailed;
        static SIGNED_LONG_INTEGER CloudQueueServer;
        static SIGNED_LONG_INTEGER NoContent;
        static SIGNED_LONG_INTEGER SkipLimitReached;
        static SIGNED_LONG_INTEGER CommandFailed;
        static SIGNED_LONG_INTEGER DisallowedByPolicy;
    };

    static class SonosPlayerCommand // enum
    {
        static SIGNED_LONG_INTEGER None;
        static SIGNED_LONG_INTEGER LoadFavorite;
        static SIGNED_LONG_INTEGER Play;
        static SIGNED_LONG_INTEGER Pause;
        static SIGNED_LONG_INTEGER SkipToNextTrack;
        static SIGNED_LONG_INTEGER SkipToPreviousTrack;
        static SIGNED_LONG_INTEGER SetPlayMode;
        static SIGNED_LONG_INTEGER LoadLineIn;
    };
